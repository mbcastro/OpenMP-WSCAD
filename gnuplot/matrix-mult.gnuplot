...
set output "img/matrix-mult.eps"
...
plot  "results/matrix-mult1.csv" using 0:2:3 with yerrorbars title "Laço Externo" ls 5, \
	 '' using 0:2 with lines ls 5 notitle,                      \
	 "results/matrix-mult2.csv" using 0:2:3 with yerrorbars title "Laço Interno" ls 6,   \
