...
\section{Conceitos Básicos}
	...
	\subsection{Regiões Paralelas}
		...
		\textit{worker threads} para executar os comandos especificados.  No
		...
		função utilitária do OpenMP \texttt{omp\_get\_thread\_num()}, como é
		mostrado. Ao final de toda região paralela, uma barreira implícita
		força a sincronização da computação feita pelas threads.
...
\end{lstlisting}
		...
		definição da variável de ambiente \texttt{OMP\_NUM\_THREADS}.
