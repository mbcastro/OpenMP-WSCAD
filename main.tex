...
\section{Conceitos Básicos}
	...
	\subsection{Modelo Fork-Join}
		...
		execução com uma única \textit{thread}, denominada \textit{master thread} (Figura~\ref{fig:fork-join}a). A
...
\end{lstlisting}
	...
	\label{subsection: escalonamento de iteracoes}
		...
		escalar quando comparada às política Static e Guided.

		\begin{figure}
			\centering
			\includegraphics[width=0.45\linewidth]{img/smm}
		\end{figure}
