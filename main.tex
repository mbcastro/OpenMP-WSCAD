...
\end{lstlisting}
		...
		\todo[inline]{Faltou comentar os cache missses.}
...
\end{lstlisting}
		...
		\begin{figure}[b]
			\centering
			\includegraphics[width=0.5\linewidth]{img/smm}
			\caption{Comparação do desempenho da multiplicação de matrizes esparsas com
			diferentes estratégias de escalonamento disponíveis no OpenMP.}
			\label{fig:static-dynamic-guided}
		\end{figure}

	\todo[inline]{Faltou o resultado com Guided!}
