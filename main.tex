...
\label{sec:conceitos basicos}
	...
	\subsection{Arquiteturas Alvo}
		...
		principal pode ser pequeno (acesso a um banco de memória local)
		ou grande (acesso a um banco de memória remoto), dependendo da
		distância entre o processador ou \textit{core} e o banco de
		memória que esse processador ou \textit{core} está acessando.  
		Arquiteturas do tipo NUMA possuem maior potencial de
		escalabilidade que arquiteturas UMA, porém, em contrapartida são
		mais complexas, caras e de difícil programação.
	...
	\subsection{Regiões Paralelas e Compartilhamento de Dados}
		...
		diretiva \texttt{omp\_parallel}, como é ilustrado no Fragmento de Código~\ref{listing:sayhello}.
...
\end{lstlisting}
	...
	\label{subsection: escalonamento de iteracoes}
		...
		% Análise de Desempenho
		O Fragmento de Código~\ref{listing:sparsematrixmult} ilustra o uso desses dois
...
\end{lstlisting}
	...
	\todo[inline]{1) remover a legenda; 2) alterar o label do eixo x para ``Task Grain Size''.}
			...
			\centering
				...
				\begin{subfigure}{0.45\linewidth}
					...
					\resizebox{0.725\linewidth}{!}{
            					\begin{tabular}{cc}
            						\toprule
            						\texttt{stop} 	& Ganho (sobre \texttt{stop=14}) \\ \midrule					
            						16			& 2,79\\
            						18			& 8,37\\
            						20			& 17,15\\
            						22			& 18,82\\
            						24			& 18,56\\
            						\textbf{26}			& \textbf{19,80}\\
            						28			& 18,99\\
            						30			& 19,33\\
            						32			& 19,03\\ 
							34			& 19,52\\
