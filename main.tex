...
\label{sec:paralelismo tarefas}
	...
	paralelizado com o uso de tarefas é a sequência de
	...
	de tarefas para o cálculo da sequência de Fibonacci usando tarefas.
	Nesse exemplo, considera-se uma solução básica recursiva para o cálculo
	da sequência de Fibonacci com computações redundantes. Porém,
	...
	implementação básica (com computação redundante) para o cálculo da sequência de
	Fibonacci usando tarefas em \openmp. Primeiramente é criada uma
	região paralela com a diretiva \texttt{omp parallel} (linha
...
unsigned long int fibonacci(int n, int stop)
{
...
unsigned long int recursive_fibonacci(int n, int stop)
{
