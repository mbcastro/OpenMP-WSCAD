...
\begin{abstract}
	The use of parallel architectures with massive amounts of
	...
	discusses how to develop efficient parallel applications
	\openmp, an application programming interface for shared memory parallel
	architectures, which is widely used by industry and academia. To accomplish
...
\begin{lstlisting}[frame=single,caption=Paralelização da multiplicação de matrizes no \openmp.,label=listing:matrixmult]
